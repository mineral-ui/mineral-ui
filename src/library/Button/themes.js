...
export const buttonTheme: ButtonThemeFn = (baseTheme) => ({
  ...
  Button_paddingHorizontal: baseTheme.space_inset_sm_plus,
  ...
  Button_height_medium: baseTheme.button_size_medium,
  Button_height_large: baseTheme.button_size_large,
  Button_height_jumbo: baseTheme.button_size_jumbo,

  ButtonContent_fontSize: baseTheme.fontSize_ui_sm,
