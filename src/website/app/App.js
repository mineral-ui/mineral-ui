...
const siteTheme = {
  ...
  borderColor_focus: siteColors.orange,
  color_text: mineralTheme.color_gray_80,
  color_text_primary: siteColors.orange,
  fontFamily: null,
  ...
  SiteButton_backgroundColor_primary: siteColors.orange,
  SiteButton_backgroundColor_primary_active: siteColors.orange_active,
  SiteButton_backgroundColor_primary_focus: siteColors.orange_focus,
  SiteButton_backgroundColor_primary_hover: siteColors.orange_hover,

  SiteHeading_color_2: siteColors.slate,
  SiteHeading_color_3: siteColors.orange,
  SiteHeading_color_4: siteColors.slate,
