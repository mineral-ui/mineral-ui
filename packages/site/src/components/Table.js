...
export const Cell = createStyledComponent('td', styles.cell);
export const ColumnHeader = createStyledComponent('th', styles.columnHeader);
export const TableRow = createStyledComponent('tr', styles.tr);
