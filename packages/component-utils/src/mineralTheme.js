...
export default {
  ...
  color_text_danger_active: color.red_90,
  ...
  color_text_warning: color.orange_80,
  color_text_warning_active: color.orange_90,
  color_text_warning_focus: color.orange_80,
  color_text_warning_hover: color.orange_70,
