...
export default function IconAccountBalanceWallet(props: IconProps) {
  const iconProps = {
    rtl: false,
    ...props
  };
...
IconAccountBalanceWallet.displayName = 'IconAccountBalanceWallet';
IconAccountBalanceWallet.category = 'action';
