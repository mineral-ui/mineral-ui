...
export default function IconAirlineSeatLegroomExtra(props: IconProps) {
  const iconProps = {
    rtl: false,
    ...props
  };
...
IconAirlineSeatLegroomExtra.displayName = 'IconAirlineSeatLegroomExtra';
IconAirlineSeatLegroomExtra.category = 'notification';
