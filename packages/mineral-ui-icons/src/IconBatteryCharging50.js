...
export default function IconBatteryCharging50(props: IconProps) {
  const iconProps = {
    rtl: false,
    ...props
  };
...
IconBatteryCharging50.displayName = 'IconBatteryCharging50';
IconBatteryCharging50.category = 'device';
