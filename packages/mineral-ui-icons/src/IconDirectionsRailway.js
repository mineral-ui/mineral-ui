...
export default function IconDirectionsRailway(props: IconProps) {
  const iconProps = {
    rtl: false,
    ...props
  };
...
IconDirectionsRailway.displayName = 'IconDirectionsRailway';
IconDirectionsRailway.category = 'maps';
