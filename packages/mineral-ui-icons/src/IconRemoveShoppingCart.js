...
export default function IconRemoveShoppingCart(props: IconProps) {
  const iconProps = {
    rtl: false,
    ...props
  };
...
IconRemoveShoppingCart.displayName = 'IconRemoveShoppingCart';
IconRemoveShoppingCart.category = 'action';
