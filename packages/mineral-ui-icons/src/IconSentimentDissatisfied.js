...
export default function IconSentimentDissatisfied(props: IconProps) {
  const iconProps = {
    rtl: false,
    ...props
  };
...
IconSentimentDissatisfied.displayName = 'IconSentimentDissatisfied';
IconSentimentDissatisfied.category = 'social';
