...
export default function IconSettingsInputAntenna(props: Props) {
  const iconProps = {
    rtl: false,
    ...props
  };
...
IconSettingsInputAntenna.displayName = 'IconSettingsInputAntenna';
IconSettingsInputAntenna.category = 'action';
