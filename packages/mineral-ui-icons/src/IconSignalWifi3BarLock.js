...
export default function IconSignalWifi3BarLock(props: Props) {
  const iconProps = {
    rtl: false,
    ...props
  };
...
IconSignalWifi3BarLock.displayName = 'IconSignalWifi3BarLock';
IconSignalWifi3BarLock.category = 'device';
