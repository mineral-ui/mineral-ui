...
export default function IconBatteryCharging60(props: IconProps) {
  const iconProps = {
    rtl: false,
    ...props
  };
...
IconBatteryCharging60.displayName = 'IconBatteryCharging60';
IconBatteryCharging60.category = 'device';
