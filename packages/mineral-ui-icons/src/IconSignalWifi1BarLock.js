...
export default function IconSignalWifi1BarLock(props: IconProps) {
  const iconProps = {
    rtl: false,
    ...props
  };
...
IconSignalWifi1BarLock.displayName = 'IconSignalWifi1BarLock';
IconSignalWifi1BarLock.category = 'device';
