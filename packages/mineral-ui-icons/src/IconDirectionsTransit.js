...
export default function IconDirectionsTransit(props: IconProps) {
  const iconProps = {
    rtl: false,
    ...props
  };
...
IconDirectionsTransit.displayName = 'IconDirectionsTransit';
IconDirectionsTransit.category = 'maps';
