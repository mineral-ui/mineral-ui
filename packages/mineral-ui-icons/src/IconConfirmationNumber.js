...
export default function IconConfirmationNumber(props: IconProps) {
  const iconProps = {
    rtl: false,
    ...props
  };
...
IconConfirmationNumber.displayName = 'IconConfirmationNumber';
IconConfirmationNumber.category = 'notification';
