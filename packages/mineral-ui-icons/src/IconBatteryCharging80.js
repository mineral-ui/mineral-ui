...
export default function IconBatteryCharging80(props: IconProps) {
  const iconProps = {
    rtl: false,
    ...props
  };
...
IconBatteryCharging80.displayName = 'IconBatteryCharging80';
IconBatteryCharging80.category = 'device';
