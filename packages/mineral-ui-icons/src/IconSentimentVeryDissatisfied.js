...
export default function IconSentimentVeryDissatisfied(props: IconProps) {
  const iconProps = {
    rtl: false,
    ...props
  };
...
IconSentimentVeryDissatisfied.displayName = 'IconSentimentVeryDissatisfied';
IconSentimentVeryDissatisfied.category = 'social';
