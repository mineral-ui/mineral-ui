...
export default function IconBatteryCharging20(props: IconProps) {
  const iconProps = {
    rtl: false,
    ...props
  };
...
IconBatteryCharging20.displayName = 'IconBatteryCharging20';
IconBatteryCharging20.category = 'device';
